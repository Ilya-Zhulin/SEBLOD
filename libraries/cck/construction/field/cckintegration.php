...
class JFormFieldCckIntegration extends JFormField {
    ...
    protected function getInput() {
        ...
        // Prepare
        $html   = array();
        $html[] = '<p class="tab-description alert alert-info">' . JText::_('COM_CCK_CONFIG_INTEGRATION_CONTENT_OBJECTS_DESC') . '</p>';
        $html[] = '<joomla-tab orientation="horizontal" id="integration-sliders">';
        ...
        foreach ($groups as $i => $group) {
            ...
            $html[] = '<joomla-tab-element id="permission-' . $group->name . '" role="tabpanel" name="' . $group->title . '">';
